...
public abstract class Expression {
	...
	/**
	 * Tells an expression that an inner expression may have changed and that
	 * the type should be recalculated.
	 * <p/>
	...
	/**
	 * Tells an expression that an outer expression has changed our type and
	 * that the inner types should be recalculated.
	 */
	 ...
	 * <ul>
	 * <li>1000 constant</li>
	 * <li>950 new, .(field access), []</li>
	 * <li>900 new[]</li>
	 * <li>800 ++,-- (post)</li>
	 * <li>700 ++,--(pre), +,-(unary), ~, !, cast</li>
	 * <li>650 *,/, %</li>
	 * <li>610 +,-</li>
	 * <li>600 <<, >>, >>></li>
	 * <li>550 >, <, >=, <=, instanceof</li>
	 * <li>500 ==, !=</li>
	 * <li>450 &</li>
	 * <li>420 ^</li>
	 * <li>410 |</li>
	...
	/**
	 * Checks if this expression contains a load, that matches the given
	 * CombineableOperator (which must be an Operator)
	 * 
	 * @param e
	 ...
	 * 
	 * @param e
	 *            The store expression, the operator must be a
	 *            CombineableOperator.
	 ...
	 * <p/>
	 * In this case this is a non void LocalStoreOperator, whose local isn't
